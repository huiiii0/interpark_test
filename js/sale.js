$.ajax({
    ...
    .done(function( msg ) {
        ...
        for(var i=0; i<lis.length; i++){
            $("#month .monthSer .section #list_a .box").eq(i).append("<a href='sub.html' target='_self'><img src='"+msg.documents[i].thumbnail+"'/></a></div>");
...
$.ajax({
    ...
    .done(function( msg ) {
        ...
        for(var i=0; i<lis.length; i++){
            $("#month .monthSer .section #list_b .box").eq(i).append("<a href='sub.html' target='_self'><img src='"+msg.documents[i].thumbnail+"'/></a></div>");
