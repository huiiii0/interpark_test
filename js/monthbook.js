...
$.ajax({
    ...
    .done(function( msg ) {
        ...
        for(var i=0; i<lis.length; i++){
            $("#month .monthRec .box2 .moslide li .mbox1 .imgbox").eq(i).append("<a href='sub.html' target='_self'><img src='"+msg.documents[i].thumbnail+"'/></a></div>");
...
$.ajax({
    ...
    .done(function( msg ) {
        ...
        for(var i=0; i<lis.length; i++){
            $("#month .monthRec .box2 .moslide li .mbox2 .imgbox").eq(i).append("<a href='sub.html' target='_self'><img src='"+msg.documents[i].thumbnail+"'/></a></div>");
