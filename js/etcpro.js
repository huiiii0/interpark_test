...
$.ajax({
    ...
    .done(function( msg ) {
        ...
        for(var i=0; i<lis.length; i++){
            $("#etc .eslide1 li").eq(i).append("<a href='sub.html' target='_self'><img src='"+msg.documents[i].thumbnail+"'/></a>");
...
$.ajax({
    ...
    .done(function( msg ) {
        ...
        for(var i=0; i<lis.length; i++){
            $("#etc .eslide2 li").eq(i).append("<a href='sub.html' target='_self'><img src='"+msg.documents[i].thumbnail+"'/></a></div>");
...
$.ajax({
    ...
    .done(function( msg ) {
        ...
        for(var i=0; i<lis.length; i++){
            $("#etc .eslide3 li").eq(i).append("<a href='sub.html' target='_self'><img src='"+msg.documents[i].thumbnail+"'/></a>");
