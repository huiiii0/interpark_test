...
$.ajax({
    ...
    .done(function( msg ) {
        ...
        for(var i=0; i<lis.length; i++){
            $("#field .section #list_a .box .imgbox").eq(i).append("<a href='sub.html' target='_self'><img src='"+msg.documents[i].thumbnail+"'/></a></div>");
    ...
    $.ajax({
        ...
        .done(function( msg ) {
            ...
            for(var i=0; i<lis.length; i++){
                $("#field .section #list_b .box .imgbox").eq(i).append("<a href='sub.html' target='_self'><img src='"+msg.documents[i].thumbnail+"'/></a></div>");
        ...
        $.ajax({
            ...
            .done(function( msg ) {
                ...
                for(var i=0; i<lis.length; i++){
                    $("#field .section #list_c .box .imgbox").eq(i).append("<a href='sub.html' target='_self'><img src='"+msg.documents[i].thumbnail+"'/></a></div>");
            ...
            $.ajax({
                ...
                .done(function( msg ) {
                    ...
                    for(var i=0; i<lis.length; i++){
                        $("#field .section #list_d .box .imgbox").eq(i).append("<a href='sub.html' target='_self'><img src='"+msg.documents[i].thumbnail+"'/></a></div>");
                ...
                $.ajax({
                    ...
                    .done(function( msg ) {
                        ...
                        for(var i=0; i<lis.length; i++){
                            $("#field .section #list_e .box .imgbox").eq(i).append("<a href='sub.html' target='_self'><img src='"+msg.documents[i].thumbnail+"'/></a></div>");
                    ...
                    $.ajax({
                        ...
                        .done(function( msg ) {
                            ...
                            for(var i=0; i<lis.length; i++){
                                $("#field .section #list_f .box .imgbox").eq(i).append("<a href='sub.html' target='_self'><img src='"+msg.documents[i].thumbnail+"'/></a></div>");
